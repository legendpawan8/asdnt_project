            ...
            foreach ($menuItems as $itemName => $itemLink) {
                if ($itemName == "Services") {
                    ...
                    <div class='relative group'>
                        <a href='#' class='flex items-center text-white text-l hover:text-gray-200 ' style='font-family: \"Orbitron\", sans-serif;'>$itemName
                        ...
                        <div class='dropdown-content absolute hidden group-hover:block bg-white/5 backdrop-blur-lg text-white py-2 px-4 rounded-lg shadow-lg z-50'>
                    ...
                    echo "<a href='$itemLink' class='text-white text-l glow-effect ' style='font-family: \"Orbitron\", sans-serif;'>$itemName</a>";
                }
            }
            ?>
        </div>
